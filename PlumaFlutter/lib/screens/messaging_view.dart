        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(
                color:
                    PlumaColors.onSurfaceVariant.withValues(alpha: 0.5),
                fontSize: 12,
              ),
              filled: true,
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final isSelf = u.username == widget.currentUser.username;
              return ListTile(
                onTap: () => _selectPerson(u),
                leading: NeonAvatar(
                    image: u.pfp, online: true, size: 40),
                title: Row(
                  children: [
                    Expanded(
                      child: Text(
                    ...
                    if (isSelf)
                      Text(
                        ...
                        style: TextStyle(
                          color:
                              PlumaColors.primary.withValues(alpha: 0.7),
                          fontSize: 10,
                          fontFamily: 'monospace',
                        ),
                      ),
        ...
        Container(
          ...
          child: Row(
            children: [
              GestureDetector(
                onTap: () =>
                    setState(() => _mobileShowChat = false),
  ...
  Widget _buildAddModal() {
    final others = widget.allUsers
        ...
        .where((u) =>
            u.username
                .toLowerCase()
                .contains(_modalSearch.toLowerCase()) ||
        ...
        children: [
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return ListTile(
                        ...
                        leading:
                            NeonAvatar(image: u.pfp, size: 40),
                        title: Text(
                          '@${u.username}',
                          style: const TextStyle(
                            color: PlumaColors.onSurface,
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              NeonButton(
                  label: 'dodaj', onPressed: _addCustomUser),
            ],
          ),
        ],
      ),
